package net.dev.mylib.time.DateTimePicker;

import java.util.Calendar;

import net.dev.mylib.DebugLogs;
import net.dev.mylib.time.DateTimePicker.DateTimePicker.OnDateTimeChangedListener;
...
//		setButton2("取消", (OnClickListener) null);
	...
	public DateTimePickerDialog(Context context, final long date,boolean isDate) {
		super(context);
		...
		mDateTimePicker.setOnDateTimeChangedListener(new OnDateTimeChangedListener() {
					...
					public void onDateTimeChanged(DateTimePicker view,
						...
						mDate.set(Calendar.MINUTE, minute);
						mDate.set(Calendar.SECOND, 0);
						updateTitle(mDate.getTimeInMillis(), true);
						DebugLogs.i("date the date is "+net.dev.mylib.time.calendar.DateFormat.formatDate(mDate.getTimeInMillis(), "yyyy-MM-dd"));
					}
				});
...
//		setButton2("取消", (OnClickListener) null);
	...
	private void updateTitle(long date,boolean isDate){
		int flag = isDate ? (DateUtils.FORMAT_SHOW_YEAR | DateUtils.FORMAT_SHOW_DATE
				| DateUtils.FORMAT_SHOW_WEEKDAY):DateUtils.FORMAT_SHOW_YEAR | DateUtils.FORMAT_SHOW_DATE
				| DateUtils.FORMAT_SHOW_WEEKDAY | DateUtils.FORMAT_SHOW_TIME;
		setTitle(DateUtils.formatDateTime(this.getContext(), date, flag));
	}
